...
{
	/*
	{ _T("图像文件名"),			_T("图像"),				_T(""),		LVCFMT_LEFT,	105 },
	...
	{ _T("图像方向"),			_T("方向"),				_T(""),		LVCFMT_LEFT,	 70 },
	{ _T("图像尺寸"),			_T("尺寸"),				_T(""),		LVCFMT_RIGHT,	 75 },
	{ _T("文件大小"),			_T("文件大小"),			_T(""),		LVCFMT_RIGHT,	 55 },
	{ _T("图像路径"),			_T("路径"),				_T(""),		LVCFMT_LEFT,	120 },
	...
	*/
	{ _T("图像文件名"),			_T("图像"),				_T(""),		LVCFMT_LEFT,	215 },
	{ _T("文件扩展名"),			_T("扩展名"),			_T(""),		LVCFMT_LEFT,	 60 },
	{ _T("日期和时间"),			_T("日期和时间"),		_T(""),		LVCFMT_LEFT,	155 },
	{ _T("相机厂商"),			_T("厂商"),				_T(""),		LVCFMT_LEFT,	 85 },
	{ _T("相机型号"),			_T("型号"),				_T(""),		LVCFMT_LEFT,	135 },
	{ _T("镜头型号"),			_T("镜头型号"),			_T(""),		LVCFMT_LEFT,	135 },
	{ _T("感光度"),				_T("感光度"),			_T(""),		LVCFMT_RIGHT,	 70 },
	{ _T("曝光时长"),			_T("曝光时长"),			_T("s"),	LVCFMT_RIGHT,	 75 },
	{ _T("光圈"),				_T("光圈"),				_T(""),		LVCFMT_RIGHT,	 60 },
	{ _T("焦距"),				_T("焦距"),				_T("mm"),	LVCFMT_RIGHT,	 70 },
	{ _T("图像尺寸"),			_T("尺寸"),				_T(""),		LVCFMT_RIGHT,	105 },
	{ _T("文件大小"),			_T("文件大小"),			_T(""),		LVCFMT_RIGHT,	 85 },
	{ _T("焦距 (35mm等效)"),	_T("焦距 (35 mm)"),		_T("mm"),	LVCFMT_RIGHT,	 80 },
	{ _T("曝光补偿"),			_T("曝光补偿"),			_T("EV"),	LVCFMT_RIGHT,	 60 },
	{ _T("闪光"),				_T("闪光"),				_T(""),		LVCFMT_LEFT,	 40 },
	{ _T("曝光程序"),			_T("曝光程序"),			_T(""),		LVCFMT_LEFT,	 95 },
	{ _T("测光模式"),			_T("测光模式"),			_T(""),		LVCFMT_LEFT,	100 },
